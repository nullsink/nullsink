    ...
    <Layout>
      <section className="legal">
        ...
        <p>
          ...
          identity, and keep no request logs. We never carry out identity verification or know-your-customer
        ...
        <p>
          Your key is generated in your own browser. We receive and store only its hash, together with a
        ...
        <p>
          Requests are fulfilled by third-party providers (currently Anthropic, and OpenAI when enabled).
