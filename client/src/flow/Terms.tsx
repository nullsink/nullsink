// The policy / warning label, kept light: a small "terms" header over a plain dash list, no box. ONLY the
// two non-recoverable warnings (no refunds; lose the key, lose the balance) are highlighted (.hl.danger) —
// a warning label where every line shouts is a label where nothing does, so the rest stay plain with an
// acid lead-in (.lead-term.acid) on the two you can't undo.
