...
//   • store:false — disable optional OpenAI application-state storage/server-side chaining (clients resend
//     context instead). This does not control OpenAI's separate abuse-monitoring logs; upstream retention
//     remains governed by the operator account's approved data controls and OpenAI policy.
