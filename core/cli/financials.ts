...
//
//   bun core/cli/financials.ts report-YYYYMMDDTHHMMSSZ.json
//   ssh production 'cat /path/to/latest-report.json' | bun core/cli/financials.ts -
...
const USAGE = "usage: bun core/cli/financials.ts REPORT.json|- [--since YYYY-MM-DD] [--until YYYY-MM-DD]";
