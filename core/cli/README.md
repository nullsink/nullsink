...
default so SQLite cannot leave root-owned sidecars. This is a deliberate operator exception: the `nullsink`
principal may read both databases, while no network-facing service principal can.
