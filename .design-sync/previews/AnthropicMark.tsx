import { AnthropicMark } from "nullsink-client";
    ...
    <div className="pcard">
      ...
      <div className="pcard-body">
        <div className="pcard-head">
          <AnthropicMark className="pcard-logo" />
          <div className="pcard-name">
            <h3 className="pcard-title">Anthropic</h3>
            <span className="pcard-count">9 models</span>
          </div>
        </div>
      </div>
    </div>
...
// the uppercase rail name (Api.tsx Coins + Rail).
export const ApiCoin = () => (
  <Void>
    <div className="rail-head">
      <span className="ep-coins" aria-hidden="true">
        <span className="ep-disc">
          <AnthropicMark className="ep-ico" />
        </span>
      </span>
      <span className="rail-name">anthropic messages</span>
    </div>
  </Void>
);
